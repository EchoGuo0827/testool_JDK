 ...
 * file name 		: BluetoothBase4.java 
 * Author 			: wangxy
 * version 			: 
 * DATE 			: 20180226
 * directory 		: 
 * description 		: 蓝牙底座的USB串口模块
 * related document : 
 ...
 ************************************************************************/
@SuppressLint("NewApi")
public class BluetoothBase4 extends UnitFragment
{
	
	/*------------global variables definition-----------------------*/
	private final String TESTITEM = "USB串口模块";
	public final String TAG = BluetoothBase4.class.getSimpleName();
...
//			buf[j] = (byte) (Math.random()*256);
		...
		gui.cls_show_msg1(2, "USB串口未打开，流程异常测试...");
		nlBluetooth.portClose(portType);
